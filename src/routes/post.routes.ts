...
import { createPost, getAll, getById, getBySlug, getSomeByTag, deletePost, likeOrDislikePost, getStatistic, incrementView, updatePost, } from '~/controllers/post.controller.js';
