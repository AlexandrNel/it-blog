...
export type UseEditPostCommentOptions = Omit<
  UseMutationOptions<Pick<TComment.Comment, "content" | "id">, DefaultError, TComment.EditCommentRequest>,
  "mutationFn"
>;

export const useEditPostComment = ({ onSuccess, ...rest }: UseEditPostCommentOptions = {}) => {
  const queryClient = useQueryClient();
  return useMutation<Pick<TComment.Comment, "content" | "id">, DefaultError, TComment.EditCommentRequest>({
