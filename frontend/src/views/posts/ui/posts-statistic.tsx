...
import { usePostStatistic } from "../model/use-post-statistic";
...
export const PostStatistic = ({ className, postId }: Props) => {
  const { data, loading, like, dislike, isDisliked, isLiked } = usePostStatistic(postId);
