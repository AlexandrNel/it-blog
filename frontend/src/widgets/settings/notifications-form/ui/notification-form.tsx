...
export function NotificationForm() {
  const { control, handleSubmit, setError } = useForm<NotificationSettingsFormValues>({
    resolver: zodResolver(notificationSettingsSchema),
  });

  const onSubmit = createHandleSubmit<NotificationSettingsFormValues>(setError, async () => {});
  const loading = false;
  return (
